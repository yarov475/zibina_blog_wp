...
<?php require('menu.php'); ?>
    ...
    <div align="center">
        ...
        <p class="animated  fadeInRightBig delay-2s"> Зыбина Г.Н. <em>биолог</em>. Долгое время она работала педагогом в<acronym
            ...
            талантливый педагог и живописец, но стала художником только выучив сына. Судьба свела женщину с тем же
            педагогом</a>, который учмл ее ребенка. Ее картины это творчество
